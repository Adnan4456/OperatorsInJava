public class BinaryOperatorExample {
    ...
    public static void main(String[] args)
    {
        ...
        //could also be written as : a+ (e * b) -  (f / c ) % b;
        ...
        //of operation . Result is easier to understand when the divisior
        //is greator than dividend.
        ...
        System.out.println("Modulus examples where integar divisor " + " > integer dividend ");
        ...
        System.out.println("<odulus example where double divisor > double dividend");
        //C , C++  accepts only integral operands
        //Java accepts floating point operand as well
